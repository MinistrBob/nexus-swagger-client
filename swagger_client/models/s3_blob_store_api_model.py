...
class S3BlobStoreApiModel(object):
    ...
    def __init__(self, name=None, soft_quota=None, bucket_configuration=None, _configuration=None):  # noqa: E501
    ...
    def soft_quota(self):
        ...
        Settings to control the soft quota.  # noqa: E501
    ...
    def bucket_configuration(self):
        ...
        The S3 specific configuration details for the S3 object that'll contain the blob store.  # noqa: E501
    ...
    def bucket_configuration(self, bucket_configuration):
        ...
        """
        if self._configuration.client_side_validation and bucket_configuration is None:
