...
class UpdateLdapServerXo(object):
    ...
    def search_base(self, search_base):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and search_base is None:
    ...
    def auth_scheme(self, auth_scheme):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and auth_scheme is None:
        ...
        if (self._configuration.client_side_validation and
                auth_scheme not in allowed_values):
            raise ValueError(
    ...
    def connection_timeout_seconds(self, connection_timeout_seconds):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and connection_timeout_seconds is None:
    ...
    def connection_retry_delay_seconds(self, connection_retry_delay_seconds):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and connection_retry_delay_seconds is None:
    ...
    def max_incidents_count(self, max_incidents_count):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and max_incidents_count is None:
    ...
    def auth_password(self, auth_password):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and auth_password is None:
