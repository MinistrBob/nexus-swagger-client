...
class YumAttributes(object):
    ...
    def __init__(self, repodata_depth=None, deploy_policy=None, _configuration=None):  # noqa: E501
    ...
    def repodata_depth(self, repodata_depth):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and repodata_depth is None:
    ...
    def deploy_policy(self, deploy_policy):
        ...
        if (self._configuration.client_side_validation and
                deploy_policy not in allowed_values):
            raise ValueError(
