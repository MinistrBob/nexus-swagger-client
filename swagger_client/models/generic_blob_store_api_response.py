...
class GenericBlobStoreApiResponse(object):
    ...
    def __init__(self, soft_quota=None, name=None, type=None, blob_count=None, total_size_in_bytes=None, available_space_in_bytes=None, _configuration=None):  # noqa: E501
