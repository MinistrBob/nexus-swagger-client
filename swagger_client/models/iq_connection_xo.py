...
class IqConnectionXo(object):
    ...
    def __init__(self, enabled=None, show_link=None, url=None, authentication_type=None, username=None, password=None, use_trust_store_for_url=None, timeout_seconds=None, properties=None, _configuration=None):  # noqa: E501
