...
class BowerProxyRepositoryApiRequest(object):
    ...
    def __init__(self, name=None, online=None, storage=None, cleanup=None, proxy=None, negative_cache=None, http_client=None, routing_rule=None, bower=None, _configuration=None):  # noqa: E501
