...
class MavenProxyApiRepository(object):
    ...
    def __init__(self, name=None, online=None, storage=None, cleanup=None, proxy=None, negative_cache=None, http_client=None, routing_rule_name=None, maven=None, _configuration=None):  # noqa: E501
    ...
    def maven(self, maven):
        ...
        """
        if self._configuration.client_side_validation and maven is None:
