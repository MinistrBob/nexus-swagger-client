...
class Request(object):
    ...
    def __init__(self, system_information=None, thread_dump=None, metrics=None, configuration=None, security=None, log=None, task_log=None, audit_log=None, jmx=None, limit_file_sizes=None, limit_zip_size=None, _configuration=None):  # noqa: E501
