...
class ProxyAttributes(object):
    ...
    def __init__(self, remote_url=None, content_max_age=None, metadata_max_age=None, _configuration=None):  # noqa: E501
    ...
    def content_max_age(self, content_max_age):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and content_max_age is None:
    ...
    def metadata_max_age(self, metadata_max_age):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and metadata_max_age is None:
