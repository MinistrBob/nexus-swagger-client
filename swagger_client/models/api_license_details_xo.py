...
class ApiLicenseDetailsXO(object):
    ...
    def __init__(self, contact_email=None, contact_company=None, contact_name=None, effective_date=None, expiration_date=None, license_type=None, licensed_users=None, fingerprint=None, features=None, _configuration=None):  # noqa: E501
