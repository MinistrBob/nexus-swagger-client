...
class ApiUser(object):
    ...
    def __init__(self, user_id=None, first_name=None, last_name=None, email_address=None, source=None, status=None, read_only=None, roles=None, external_roles=None, _configuration=None):  # noqa: E501
