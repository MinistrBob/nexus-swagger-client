...
class DockerAttributes(object):
    ...
    def __init__(self, v1_enabled=None, force_basic_auth=None, http_port=None, https_port=None, _configuration=None):  # noqa: E501
    ...
    def v1_enabled(self, v1_enabled):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and v1_enabled is None:
    ...
    def force_basic_auth(self, force_basic_auth):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and force_basic_auth is None:
