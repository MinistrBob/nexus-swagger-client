...
class TaskXO(object):
    ...
    def __init__(self, id=None, name=None, type=None, message=None, current_state=None, last_run_result=None, next_run=None, last_run=None, _configuration=None):  # noqa: E501
