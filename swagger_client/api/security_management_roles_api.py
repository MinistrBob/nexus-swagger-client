...
class SecurityManagementRolesApi(object):
    ...
    def update1(self, id, body, **kwargs):  # noqa: E501
        """Update role  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update1(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update1_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update1_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update1_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Update role  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update1_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
